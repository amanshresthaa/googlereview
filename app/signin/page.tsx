...
export default function SignInPage() {
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 overflow-hidden relative">
      ...
      >
        <div className="rounded-[40px] border border-border/50 shadow-google-xl bg-card p-8 md:p-12">
          <div className="flex flex-col items-center text-center mb-10">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm font-bold text-muted-foreground uppercase tracking-[0.2em]">Review Intelligence</p>
            </div>
          </div>

          <div className="rounded-[24px] bg-muted/30 border border-border/50 p-6 text-sm md:text-base text-muted-foreground leading-relaxed font-medium text-center">
          ...
          <div className="mt-10">
            <Button
              ...
              className="w-full rounded-[20px] bg-primary h-16 text-lg font-black shadow-glow-primary text-primary-foreground transition-all hover:bg-primary/90 hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-4"
            >
              <svg className="size-6" viewBox="0 0 48 48" fill="none">
          ...
          <div className="mt-12 grid grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="flex flex-col items-center gap-3">
                <div className={cn("h-12 w-12 rounded-2xl flex items-center justify-center shadow-sm border border-border/50", item.color)}>
          ...
          <div className="mt-12 flex items-center justify-center gap-2 text-[10px] font-bold uppercase tracking-widest text-muted-foreground/40">
